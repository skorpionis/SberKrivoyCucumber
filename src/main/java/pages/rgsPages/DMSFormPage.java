...
public class DMSFormPage extends BasePageClass {
    public List<WebElement> arrWebM(){
    ...
    public void IncorrectMailError(){
        sravnFunc("Введите адрес электронной почты", incorrectMailError);
    }
    public void SaveBtn(){
        saveBtn.click();
    }

    public void ProverkaShapkiSravnenie(String str){
       sravnFunc(str,ProverkaShapki());
    }
